<?php
require_once "../controlador/ctrlUsuarios.php";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    $controlador->iniciarSesion($nombre, $password);
}
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="">
                                    ...
                                    <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control" placeholder="Ingresa tu fecha de nacimiento">
                                    </div>
                                    <div class="form-group">
